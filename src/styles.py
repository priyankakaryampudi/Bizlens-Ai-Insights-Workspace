...
def inject_css():
    ...
    .hero{padding:.3rem 0 .8rem}.hero h1{font-size:2.7rem;line-height:1.06;margin:.35rem 0 .55rem}.hero p{max-width:900px;font-size:1rem;line-height:1.55;color:var(--muted)}
    ...
    .section-head{margin:1.45rem 0 .65rem}.section-head h2{margin:0;font-size:1.38rem}.section-head p{color:var(--muted);margin:.2rem 0}
    ...
    .footer-note{margin-top:1rem;text-align:center;color:#888;font-size:.75rem}.big-answer{font-size:1.02rem;line-height:1.75;padding:18px 20px}
